<?php
    ...
    if(!defined('MSG')){
        ...
        define('MSG_onesignal_rest_key_INCORRECT',"Oops, API Key is incorrect!");
        define('MSG_onesignal_rest_key_REQUIRED',"Oops, API Key is required!");
